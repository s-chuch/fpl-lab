window.FPL_X = {
  ...
  "split": [
    ...
    {
      "text": "Daily price risers / fallers.",
      "sources": [
        "Ghono_FF"
      ]
    }
  ...
  "seen": [
    ...
    "2099958184215503047",
    "2099958323084722450",
    "Erling Haaland is the ultimate talismanic player in FPL this season.",
    "GW5 Free Hit draft: starting XI mostly at home to promoted sides / Sunderland. Fade high-EO Palmer/Rogers.",
    "GW5 captaincy, possible Haaland entrance and potential MGW knee-jerk all discussed.",
    "GW5 wildcard draft: good entry points for Gibbs-White, Barnes and Barry (promoted sides at home).",
    "I'm big on Morgan Gibbs-White... 78.5% chance to return in GW5. And I would bring him in with a hit -4.",
    "Muharemovi\u0107 is a better asset than Hall this week.",
    "Players to buy | GW5 and GW5 transfer plans are live.",
    "Price risers and fallers, 15 Sep.",
    "Rogers.",
    "WC5 is proving trickier than expected. Wants MGW, Palmer + Rogers and Saka; may drop a mid for Slater, Saka for Rogers, keep Palmer."
  ],
